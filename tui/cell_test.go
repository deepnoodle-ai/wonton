...
func TestDirtyRegion_Clear(t *testing.T) {
	dr := &DirtyRegion{}
	// Make it dirty by marking a point
	dr.Mark(10, 5)
	dr.Mark(20, 15)
	assert.False(t, dr.Empty()) // Should be dirty now
...
func TestDirtyRegion_MarkRect_ZeroWidth(t *testing.T) {
	...
	assert.True(t, dr.Empty(), "MarkRect with zero width should not mark dirty")
}
...
func TestDirtyRegion_MarkRect_ZeroHeight(t *testing.T) {
	...
	assert.True(t, dr.Empty(), "MarkRect with zero height should not mark dirty")
}
...
func TestDirtyRegion_MarkRect_NegativeWidth(t *testing.T) {
	...
	assert.True(t, dr.Empty(), "MarkRect with negative width should not mark dirty")
}
...
func TestDirtyRegion_MarkRect_NegativeHeight(t *testing.T) {
	...
	assert.True(t, dr.Empty(), "MarkRect with negative height should not mark dirty")
}
