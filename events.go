...
// Timestamp method for KeyEvent to satisfy Event interface
func (e KeyEvent) Timestamp() time.Time {
	// KeyEvent doesn't currently store a timestamp,
	// so we return the current time when this method is called
	// TODO: Consider adding a timestamp field to KeyEvent
	return time.Now()
}

// Timestamp method for MouseEvent to satisfy Event interface
