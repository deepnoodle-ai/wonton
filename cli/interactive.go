...
import (
	"github.com/deepnoodle-ai/gooey/terminal"
	"github.com/deepnoodle-ai/gooey/tui"
)

// ViewFunc creates a Gooey view for interactive display.
type ViewFunc func(*Context) tui.View

// RunInteractive runs an interactive Gooey application within a CLI command.
...
// InteractiveApp wraps a CLI context with Gooey for rich TUI.
